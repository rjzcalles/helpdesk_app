    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-900">
      <div className="w-full max-w-md p-8 space-y-6 bg-gray-800 rounded-lg border border-gray-700">
        ...
        <form className="space-y-6" onSubmit={onSubmit}>
          ...
          <div>
            <button type="submit" className="w-full px-4 py-2 font-semibold text-white bg-blue-100 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
              Entrar
            </button>
          </div>
        </form>
